...
//                                System.out.println("찾고자하는 제목을 입력하세요 : ");
//                                mvName = sc.next();
//                                System.out.println(Arrays.toString(MovieCustomer.search(mvName)));
//                                break;
//                            case 2:
//                                System.out.println("찾고자하는 감독을 입력하세요 : ");
//                                mvName = sc.next();
//                                System.out.println(Arrays.toString(MovieCustomer.searchDirector(mvName)));
//                                break;
//                            case 3:
//                                System.out.print("찾고자하는 장르를 입력하세요 : ");
//                                sc.nextLine();
...
//                                num2 = sc.nextInt();
//                                if(num2==1){MovieCusImple.ss();}
//                                else if(num2 == 2){MovieCusImple.aa();}
//                                else if(num2 == 3){MovieCusImple.bb();}
//                            }
//
//                        } while(num!=4);
//                        break;
